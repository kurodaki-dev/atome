...
10. [Référence API — tokenizer](#référence-api--tokenizer)
11. [Référence API — device (GPU/CPU)](#référence-api--device-gpucpu)
12. [Correspondance avec PyTorch](#correspondance-avec-pytorch)
13. [Limites honnêtes, en détail](#limites-honnêtes-en-détail)
14. [Comment ça a été vérifié](#comment-ça-a-été-vérifié)
